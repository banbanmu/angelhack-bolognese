...
public class RecordingConfig {
  ...
  */
   ...
   *  <li>The recording service does not recognize a channel as an idle channel, so long as the channel has users, regardless of whether they send stream or not.</li>
   *  <li>If a live-broadcast channel has an audience without a host for a set time (`idleLimitSec`), the recording service automatically stops and leaves the channel.</li>
   * </ul>
   */
